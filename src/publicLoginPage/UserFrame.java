...
import userFrame.adminFrame.EmployeeList;
import deviceListener.LabelButtonListener;
import userFrame.adminFrame.DashBoard;
import userFrame.adminFrame.EmployeeRecuitForm;
import userFrame.adminFrame.PayrollForm;
import userFrame.adminFrame.ReportGenaration;
import userFrame.adminFrame.RevenueForm;
...
public class UserFrame extends javax.swing.JFrame {
     ...
     */
    public UserFrame(Component parent) {
        this.parent = parent;
        ...
        query.addMouseListener(new LabelButtonListener(jPanel4,query,jDesktopPane1){
            @Override
        ...
        jDesktopPane1.add(new DashBoard());
        jDesktopPane1.revalidate();
        ...
        jLabel3.addMouseListener(new LabelButtonListener(jPanel4,jLabel3,jDesktopPane1){
            ...
            public void mousePressed(MouseEvent me) {
                jDesktopPane1.removeAll();
                jDesktopPane1.add(new PayrollForm());
                jDesktopPane1.revalidate();
            }
        });
        jLabel4.addMouseListener(new LabelButtonListener(jPanel4,jLabel4,jDesktopPane1){
            ...
            public void mousePressed(MouseEvent me) {
                jDesktopPane1.removeAll();
                jDesktopPane1.add(new RevenueForm());
                jDesktopPane1.revalidate();
            }
        ...
        jLabel7.addMouseListener(new LabelButtonListener(jPanel4,jLabel7,jDesktopPane1){
            ...
            public void mousePressed(MouseEvent me) {
                jDesktopPane1.removeAll();
                jDesktopPane1.add(new ReportGenaration());
                jDesktopPane1.revalidate();
            }
            
        });
        jLabel6.addMouseListener(new LabelButtonListener(jPanel4,jLabel6,jDesktopPane1){
            @Override
            public void mousePressed(MouseEvent me) {
                   jDesktopPane1.removeAll();
                   jDesktopPane1.add(new EmployeeList());
                   jDesktopPane1.revalidate();
            }  
        });
        jLabel5.addMouseListener(new LabelButtonListener(jPanel4,jLabel5,jDesktopPane1){
            ...
            public void mousePressed(MouseEvent me) {
                jDesktopPane1.removeAll();
                jDesktopPane1.add(new EmployeeRecuitForm());
                jDesktopPane1.revalidate();
            }
